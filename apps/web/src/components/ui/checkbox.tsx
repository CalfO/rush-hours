...
import { CheckboxRootProps, Checkbox as PRCheckbox } from "primereact/checkbox";
...
function Checkbox({
  ...
  absolute inset-s-0 top-0 w-full h-full m-0 p-0 opacity-0 z-10\
 border border-slate-200 border-transparent rounded-xs dark:border-slate-800"
      {...props}
    >
      <PRCheckbox.Indicator match="checked" as={Check} />
      <PRCheckbox.Indicator match="indeterminate" as={Minus} />
    </PRCheckbox.Root>
  );
}
